...
int main() {
  ...
  std::string container = "../image/container.jpg";
  unsigned char* data =
  ...
  glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
  // load image, create texture and generate mipmaps
  std::string awesomeface = "../image/awesomeface.png";
  ...
  int nValue = 1;
  ourShader.setValuel("texture2", nValue);
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    ourShader.setValuel("nReverse", nReverse);
      ...
      trans =
          glm::rotate(trans, (float)glfwGetTime(),
                          glm::vec3(1.0f, 0.0f, 0.0f));
      //trans = glm::translate(trans, glm::vec3(0.5f, -0.5f, 0.0f));
      trans = glm::scale(trans, glm::vec3(0.5, 0.5, 0.5));
      ourShader.setMatrix4x4Array("transform", &trans, 1);
